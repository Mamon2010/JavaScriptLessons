...
/*!*******************************!*\
  ...
  \*******************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");o.default=function(){function e(e){e.style.display="block",document.body.style.overflow="hidden"}function o(o){t.forEach(function(e){e.addEventListener("click",function(){o.style.display="none",document.body.style.overflow=""})})}var s=document.querySelector(".header_btn"),n=document.querySelector(".popup_engineer"),t=document.querySelectorAll(".popup_close");s.addEventListener("click",function(){e(n)}),o(n);var r=document.querySelector(".phone_link"),u=document.querySelector(".popup");r.addEventListener("click",function(){e(u)}),o(u),document.querySelector(".phone_link_question").addEventListener("click",function(){e(u)}),o(u),setTimeout(function(){e(u)},6e4)}},"./node_modules/core-js/modules/_a-function.js":
/*!*****************************************************!*\
